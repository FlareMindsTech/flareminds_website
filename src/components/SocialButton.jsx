  ...
  return (
    <StyledWrapper>
      <ul className="wrapper">
        <li className="icon facebook" role="button" tabIndex={0} aria-label="Visit our Facebook page">
        ...
        <li className="icon email" role="button" tabIndex={0} aria-label="Email FlareMinds" onClick={() => window.location.href = 'mailto:Info@flaremindstech.com'} onKeyDown={(event) => {
          if (event.key === 'Enter' || event.key === ' ') window.location.href = 'mailto:Info@flaremindstech.com';
        }}>
        ...
        <li className="icon instagram" role="button" tabIndex={0} aria-label="Visit our Instagram page">
