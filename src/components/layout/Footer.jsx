...
import { 
  ...
  FaHome, FaThLarge, FaUser, FaBriefcase, FaBox, FaPen, FaEnvelope,
...
const CURVE_PATH = 'M0-0.3C0-0.3,464,156,1139,156S2278-0.3,2278-0.3V683H0V-0.3z';
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            el.classList.add('wave-play');
          } else {
            el.classList.remove('wave-play');
          }
        });
      },
      { threshold: 0.1 }
  ...
  return (
    <>
      <div className="footer-wave-wrap">
        <svg ref={svgRef} preserveAspectRatio="none" id="footer-wave-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2278 683">
          <defs>

          </defs>
          <path fill="url(#footer-wave-grad)" d={CURVE_PATH} />
        </svg>
      </div>
        ...
        <div className="footer-container">
          ...
          <div className="footer-col footer-brand-col">
            <div className="footer-logo">
              <img src={TitleLogo} alt="FlareMinds" width="200" height="70" decoding="async" style={{ height: '70px', width: 'auto', objectFit: 'contain' }} />
            </div>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/our-works"><FaBriefcase className="link-icon" /> Our Works <FaChevronRight className="caret" /></Link></li>
