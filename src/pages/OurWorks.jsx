...
function CardLink({ project }) {
  ...
  const label = project.status === "proto" ? "View on Play Store" : "Visit Project";
  return (
    <a
      href={project.link}
      target="_blank"
    ...
    <article className="pw-card" style={{ animationDelay: `${(serialNum % 6) * 55}ms` }}>
      ...
      <div className="pw-card-body">
        <div className="pw-card-top">
          <span className="pw-card-kicker" style={{ color: project.accent }}>
            {project.category}
          </span>
...
export default function OurWorks() {
  ...
  return (
    <div className="pw-page">
      <SEO
        title="Our Works & Portfolio | FlareMinds — Digital Products & Software"
        ...
        <div className="pw-container">
          <div className="pw-hero-inner">
            ...
            <div className="pw-stats" aria-label="Portfolio statistics">
              ...
              <div className="pw-stat">
                <div className="pw-stat-num">{(counts["e-commerce"] || 0) + (counts["service-marketplace"] || 0)}+</div>
